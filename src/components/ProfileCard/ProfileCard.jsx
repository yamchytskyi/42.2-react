...
function ProfileCard() {
    return (
        <div className="profile-card">
            ...
            <img className="avatar-img" src="https://media.licdn.com/dms/image/v2/C5603AQGTEADjq7JUAw/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1517739186258?e=2147483647&v=beta&t=iQ4qZgVssW7unoaHOjLKZFmhAKmwPvQ4TAiNQ6rI9U0"
